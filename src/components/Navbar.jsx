    ...
    return (
        <>
            <div className="nav mt-3">
                ...
                <div className="button btn btn-outline-primary" onClick={() => { setSearch("travel"); navigate("/") }}>Travel</div>
                ...
                <div className="button btn btn-outline-warning mx-3" onClick={() => { setSearch("business"); navigate("/") }}>Business & Finace</div>
                ...
                {location.pathname === "/saved" ?
                    <div className="button btn btn-outline-warning mx-3" onClick={() => navigate("/")}>Home</div> :
                    <div className="button btn btn-outline-warning mx-3" onClick={() => navigate("/saved")}>Saved</div>
                }
            </div>
            <div className="container my-4" style={{ width: '780px' }}>
                {location.pathname === "/" && (
                    <div className="mb-3">
                        <input type="email" className="form-control bg-dark text-light" id="exampleInputEmail1" aria-describedby="emailHelp" onChange={(event) => { setSearch(event.target.value) }} />
                    </div>
                )}
            </div>
        </>
